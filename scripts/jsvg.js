...
var init = function () {
	...
	window.UI = new (function (svgConverter) {
		...
		//this.fileReader.addEventListener("load", console.log);
		this.batchReadOutput = function (e) {
			var output = e.target.result;
			console.log(output);
		}
		this.batchRead = function (e) {
			var fileList = e.target.files;
			console.log("batchread executed!", fileList);
			var fileListLength = fileList.length;
			console.log("fileListLength is " + fileListLength);
			for (var ii = 0; ii < fileListLength; ii++) {
				var fileReader = new FileReader();
				fileReader.addEventListener("load", this.batchReadOutput.bind(this));
